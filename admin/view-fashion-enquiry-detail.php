...
if (strlen($_SESSION['agmsaid']==0)) {
   ...
   if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update  tblfashionenquiry set AdminRemark='$remark',Status='$status' where ID='$cid'");
    if ($query) {
...
<head>
  ...
  <title>View Orders | Art Gallery Management System</title>
...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i>View Orders</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
              <li><i class="fa fa-table"></i>Orders</li>
              <li><i class="fa fa-th-list"></i>View Orders</li>
            </ol>
          </div>
        </div>
        <!-- page start-->
  ...
  <?php
 $cid=$_GET['viewid'];
$ret=mysqli_query($con,"select tblfashionproduct.*,tblfashionenquiry.* from tblfashionenquiry 
  join tblfashionproduct on tblfashionproduct.ID=tblfashionenquiry.Artpdid 
  where tblfashionenquiry.ID='$cid'");
$cnt=1;
   ...
   <tr>
                                ...
                                <th>Fashion Name</th>
                                   <td><?php  echo $row['Title'];?><br />
                                     <a href="edit-fashion-product-detail.php?editid=<?php echo $row['Artpdid'];?>"  target="_blank">View Details</a>
                                   </td>
                                   </tr>  
                                   <tr>
