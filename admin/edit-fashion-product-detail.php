...
<head>
  ...
  <title>Add Fashion Product | Art Gallery Management System</title>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content" style="color:#000">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Add Fashion Product Detail</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
              <li><i class="icon_document_alt"></i>Fashion Product</li>
              <li><i class="fa fa-file-text-o"></i>Fashion Product Detail</li>
            </ol>
          </div>
        </div>
        <div class="row">      
