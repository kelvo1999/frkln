...
$propics=md5($img).$extension;
    ...
    $query=mysqli_query($con, "update artist set Profilepic ='$propics' where ID='$imgid'");
    if ($query) {
...
<body>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Artist Image</li>
  ...
  <?php
 $imgid=$_GET['imageid'];
$ret=mysqli_query($con,"select * from artist where ID='$imgid'");
$cnt=1;
