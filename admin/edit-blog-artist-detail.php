...
if(isset($_POST['submit']))
  ...
  $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update artist set Name='$name',MobileNumber='$mobnum',Email='$email',Education='$edudetails',Award='$awarddetails' where ID='$eid'");
    if ($query) {
...
<head>
  ...
  <title>Update Blog Artist | Art Gallery Management System</title>
...
<body>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Update Blog Artist Detail</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
              <li><i class="icon_document_alt"></i>Blog Artist</li>
              <li><i class="fa fa-file-text-o"></i>Blog Artist Details</li>
            </ol>
          </div>
        </div>
        <div class="row">
  ...
  <?php
 $cid=$_GET['editid'];
$ret=mysqli_query($con,"select * from artist where ID='$cid'");
$cnt=1;
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <img src="images/<?php echo $row['Profilepic'];?>" width="200" height="150" value="<?php  echo $row['Profilepic'];?>"><a href="changeblogpropic.php?imageid=<?php echo $row['ID'];?>" class="btn btn-success">  Edit Image</a>
                    </div>
