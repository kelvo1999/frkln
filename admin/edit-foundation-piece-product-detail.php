...
if(isset($_POST['submit']))
  {
    ...
    $eid=$_GET['editid'];
    $query=mysqli_query($con, "update tblfoundationproduct set Title='$title',Dimension='$dimension',Orientation='$orientation',Size='$size',Artist='$artist',Type='$arttype',Material='$artmed',SellingPricing='$sprice',Description='$description' where ID='$eid'");
    if ($query) {
...
<head>
  ...
  <title>Edit Foundation Piece | Art Gallery Management System</title>
      ...
      <section class="wrapper">
        ...
        <div class="row">      
          <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
            <?php
 $cid=$_GET['editid'];
$ret=mysqli_query($con,"select tblfoundation.ID as atid,tblfoundation.Type as typename,tblfoundationmaterial.ID as amid,tblfoundationmaterial.Material as amname,tblfoundationproduct.ID as apid,artist.ID as arid,artist.Name,tblfoundationproduct.Title,tblfoundationproduct.Dimension,tblfoundationproduct.Orientation,tblfoundationproduct.Size,tblfoundationproduct.Artist,tblfoundationproduct.Type,tblfoundationproduct.Material,tblfoundationproduct.SellingPricing,tblfoundationproduct.Description,tblfoundationproduct.Image,tblfoundationproduct.Image1,tblfoundationproduct.Image2,tblfoundationproduct.Image3,tblfoundationproduct.Image4,tblfoundationproduct.RefNum,tblfoundationproduct.Type from tblfoundationproduct join tblfoundation on tblfoundation.ID=tblfoundationproduct.Type join tblfoundationmaterial on tblfoundationmaterial.ID=tblfoundationproduct.Material join founder on founder.ID=tblfoundationproduct.Artist where tblfoundationproduct.ID='$cid'");
$cnt=1;
          ...
          <div class="col-lg-6">
            <section class="panel">
              <header class="panel-heading">
                Update Foundation Piece Detail
              </header>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control m-bot15" name="artist" id="artist">
                                ...
                                <?php $query1=mysqli_query($con,"select * from founder");
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control m-bot15" name="arttype" id="arttype">
                                ...
                                <?php $query2=mysqli_query($con,"select * from tblfoundation");
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control m-bot15" name="artmed" id="artmed">
                                ...
                                <?php $query3=mysqli_query($con,"select * from tblfoundationmaterial");
