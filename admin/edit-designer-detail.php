...
if(isset($_POST['submit']))
  ...
  $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update designer set Name='$name',MobileNumber='$mobnum',Email='$email',Education='$edudetails',Award='$awarddetails' where ID='$eid'");
    if ($query) {
  
    echo "<script>alert('Your Fashion Designer details has been updated.');</script>";
  }
  else
    {
...
<head>
  ...
  <title>Update Designer | FRNKL FOUNDATION</title>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Update Designer Detail</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
              <li><i class="icon_document_alt"></i>Designer</li>
              <li><i class="fa fa-file-text-o"></i>Designer Detail</li>
            </ol>
          </div>
        </div>
        <div class="row">
