...
//     if ($query) {
// echo "<script>alert('Blog Piece details has been submitted.');</script>";
...
$query = $con->prepare("INSERT INTO tblblogproduct (Title, Dimension, Orientation, Size, Artist, Type, ArtMedium, SellingPricing, Description, Image, Image1, Image2, Image3, Image4, RefNum) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
<head>
  ...
  <title>Add Blog Piece | Art Gallery Management System</title>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control m-bot15" name="artist" id="artist">
                                ...
                                <?php $query=mysqli_query($con,"select * from artist");
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control m-bot15" name="arttype" id="arttype">
                                ...
                                <?php $query=mysqli_query($con,"select * from tblblog");
              while($row=mysqli_fetch_array($query))
              {
              ?>    
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control m-bot15" name="artmed" id="artmed">
                                ...
                                <?php $query=mysqli_query($con,"select * from tblblogmaterial");
              while($row=mysqli_fetch_array($query))
              {
              ?>    
