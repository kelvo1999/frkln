...
$pagedes=$_POST['pagedes'];
 ...
 $query=mysqli_query($con,"update tblpage set PageTitle='$pagetitle',PageDescription='$pagedes' where  PageType='fashion'");

    if ($query) {
   
    echo "<script>alert('Fashion Page has been updated.');</script>";  
  }
  else
    {
...
<head>
  ...
  <title>Fashion | Art Gallery Management System</title>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i> Fashion</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
              <li><i class="icon_document_alt"></i>Fashion</li>
              <li><i class="fa fa-files-o"></i>Fashion</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
...
$ret=mysqli_query($con,"select * from  tblpage where PageType='fashion'");
$cnt=1;
